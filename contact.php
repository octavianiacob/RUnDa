    ...
    <div class="contact-form">
        ...
        <form action="contact.php" method="post">
            <div class="label-input">
                ...
                <input class="input-form" name="firstName" type="text" pattern="[A-Z]{1}[a-z]+" required placeholder="Theodor">
            </div>
            <div class="label-input">
                <label class="label-class"> Last name:</label>
                <input class="input-form" name="lastName" type="text" pattern="[A-Z]{1}[a-z]+" required placeholder="Mihalache">
            </div>

            <div class="label-input">
                <label class=" label-class"> Email:</label>
                <input class="input-form" type="email" name="email" pattern="[A-Za-z0-9._%+-]+@[a-z0-9.-]+[.]+[a-z]{2, 4}$" required placeholder="theo@gmail.com">
            </div>
            <div class="label-input">
                <label class=" label-class"> Phone:</label>
                <input class="input-form" type="text" name="phone" pattern="^(\+4|)?(07[0-8]{1}[0-9]{1}|02[0-9]{2}|03[0-9]{2}){1}?(\s|\.|\-)?([0-9]{3}(\s|\.|\-|)){2}$" required placeholder="0732113212">
            </div>
            <div class="label-input">
                <label class=" label-class"> Message:</label>
                <textarea name="message" class="input-form"  placeholder="Type your message here..." required placeholder="I'm impressed"></textarea>
            </div>
